...
contract MintableBurnableToken is StandardToken, Ownable {
  ...
  function burnForRefund() public {
    require(balances[msg.sender] == CrowdsaleInterface(owner).receivedTokensAmount(msg.sender) && CrowdsaleInterface(owner).whiteList(msg.sender) == false);
    address burner = msg.sender;
    ...
    CrowdsaleInterface(owner).forcedRefund(burner);
  }
